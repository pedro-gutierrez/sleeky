defmodule Sleeky.Entity.Generator.Metadata do
  @moduledoc false
  ...
  def generate(entity, _) do
    ...
    quote do
      ...
      def context, do: unquote(entity.context)
      def name, do: unquote(entity.name)
      def plural, do: unquote(entity.plural)
      def table_name, do: unquote(entity.table_name)
      def virtual?, do: unquote(entity.virtual?)
      def primary_key, do: unquote(Macro.escape(entity.primary_key))
