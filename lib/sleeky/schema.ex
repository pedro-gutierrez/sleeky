defmodule Sleeky.Schema do
  ...
  use Diesel,
    otp_app: :sleeky,
    dsl: Sleeky.Schema.Dsl,
    generators: [
      Sleeky.Schema.Generator.Compare,
      Sleeky.Schema.Generator.Evaluate,
      Sleeky.Schema.Generator.Filter,
      Sleeky.Schema.Generator.NearestPath,
      Sleeky.Schema.Generator.Preamble
    ]
