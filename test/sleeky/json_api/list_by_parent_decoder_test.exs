defmodule Sleeky.JsonApi.ListByParentDecoderTest do
  use Sleeky.DataCase
  ...
  describe "list by parent json api decoder" do
    test "decodes parent and includes params", context do
      ...
      assert {:ok, data} = Blog.JsonApiListByAuthorDecoder.decode(params)
    ...
    test "detects missing parent" do
      ...
      assert {:error, error} = Blog.JsonApiListByAuthorDecoder.decode(params)
